...
#include <algorithm>
using namespace cpp::reclang;
using namespace clang;

DiagnosticPrinter::DiagnosticPrinter(raw_ostream &os,
...
void DiagnosticPrinter::BeginSourceFile(const LangOptions &LO,
                                            const Preprocessor *PP) {
  // Build the TextDiagnostic utility.
  TextDiag.reset(new TextDiagnostic(OS, LO, &*DiagOpts));
}

void DiagnosticPrinter::EndSourceFile() {
  TextDiag.reset();
}
...
void DiagnosticPrinter::HandleDiagnostic(DiagnosticsEngine::Level Level,
                                             const Diagnostic &Info) {
