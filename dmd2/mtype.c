...
Type *Type::copy()
{
    Type *t = (Type *)mem.xmalloc(sizeType());
...
bool Type::equivs(RootObject *o) // CALYPSO NOTE: was introduced before dmd 2.067, similar name to next function below but equivs is used for function overloading
{
    Type *t = (Type *)o;
...
Identifier *Type::getTypeInfoIdent(int internal)
{
    ...
    OutBuffer buf;
    buf.reserve(32);
    mangleToBufferInternal(this, &buf, internal != 0);
...
Type *TypeStruct::semantic(Loc loc, Scope *sc)
{
    ...
    Type *t = merge();
    if (sym->isAnonymous()) // CALYPSO is this acceptable?
        return this;
    return t;
}
