...
Expression castTo(Expression e, Scope* sc, Type t)
{
    ...
    public:
        ...
        override void visit(Expression e)
        {
            ...
            // Reference types
            const(bool) tob_isR = (tob_isFR || tob.ty == Tpointer || tob.ty == Taarray || isClassReference(tob)); // CALYPSO
            const(bool) t1b_isR = (t1b_isFR || t1b.ty == Tpointer || t1b.ty == Taarray || isClassReference(t1b));
