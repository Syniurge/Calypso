...
ArrayLiteralExp* new_ArrayLiteralExp(const Loc& loc, Expressions *elements);
ArrayLiteralExp* new_ArrayLiteralExp(const Loc& loc, Expression *e);
ArrayLiteralExp* new_ArrayLiteralExp(const Loc& loc, Expression *basis, Expressions *elements);
ArrayLiteralExp* new_ArrayLiteralExp(const Loc& loc, Expression *basis, size_t dim);
...
NewDeclaration* new_NewDeclaration(const Loc& loc, const Loc& endloc, StorageClass stc, Parameters *arguments, int varargs);
...
OnScopeStatement* new_OnScopeStatement(const Loc& loc, TOK tok, Statement *statement);
