...
struct CatchScope {
  /// The constant corresponding to the type to match the // CALYPSO
  /// exception object against.
  llvm::Constant *clausePtr = nullptr;
...
public:
  ...
  void pushCatch(llvm::Constant *clausePtr, llvm::BasicBlock *bodyBlock); // CALYPSO
